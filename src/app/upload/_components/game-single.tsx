...
export function GameSingleUpload() {
  ...
  const watchedOriginalName = form.watch("originalName");
  const watchedOriginalAuthor = form.watch("originalAuthor");
  ...
  const extraFilledCount = useMemo(() => {
    ...
    return count;
  }, [watchedOriginalName, watchedOriginalAuthor, screenshots, videos, downloads, versions, customTabs]);
