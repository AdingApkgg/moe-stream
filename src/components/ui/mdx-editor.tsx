...
import {
  ...
  Link, Image, Code, SquareCode, List, ListOrdered,
  Quote, Table, Minus, Eye, Pencil,
} from "lucide-react";
...
const TOOLBAR_ACTIONS: ToolbarAction[] = [
  ...
  {
    icon: Table, label: "表格", prefix: "", suffix: "",
    template: "| 列1 | 列2 | 列3 |\n| --- | --- | --- |\n| 内容 | 内容 | 内容 |",
  },
...
export const MdxEditor = forwardRef<MdxEditorRef, MdxEditorProps>(
  function MdxEditor({ value = "", onChange, placeholder, className, maxLength, minHeight = "200px" }, ref) {
