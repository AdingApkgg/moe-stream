...
import { Link2, Upload, FolderOpen, X, CheckCircle2, Zap, ExternalLink } from "lucide-react";
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="upload" className="mt-2">
          {uploadedResult && value === uploadedResult.url ? (
            <div className="flex items-center gap-2.5 rounded-lg border border-green-500/20 p-3 bg-green-500/5">
